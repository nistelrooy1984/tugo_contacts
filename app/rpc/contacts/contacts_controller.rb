...
module Contacts
  class ContactsController < ::Gruf::Controllers::Base
    ...
    def get_contacts
      service = Contacts::GetContactsService.new(auth_header, jwt)
      service.run!
    ...
    def get_contact_by_id
      ...
      service = Contacts::GetContactByIdService.new(request_params, auth_header)
      service.run!
    ...
    def get_contacts_by_owner_id
      ...
      service = Contacts::GetContactsByOwnerIdService.new(request_params, auth_header)
      service.run!
      presenter = Contacts::ContactsPresenter.new(service.results)
      presenter.generate_response
    end
    ...
    def upsert_contacts
      request_params = Contacts::UpsertContactsRequestParams.new(request.message)
      request_params.validate!
