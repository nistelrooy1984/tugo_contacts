...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("tugo/contacts/v1/contact.proto", :syntax => :proto3) do
    ...
    add_message "tugo.contacts.v1.Contact" do
      ...
      optional :salutation, :message, 2, "google.protobuf.StringValue"
      optional :first_name, :message, 3, "google.protobuf.StringValue"
      optional :last_name, :message, 4, "google.protobuf.StringValue"
      optional :email, :message, 5, "google.protobuf.StringValue"
      optional :phone, :message, 6, "google.protobuf.StringValue"
      optional :title, :message, 7, "google.protobuf.StringValue"
      optional :creator_id, :message, 8, "google.protobuf.Int64Value"
      optional :owner_id, :message, 9, "google.protobuf.Int64Value"
      optional :modified_by_id, :message, 10, "google.protobuf.Int64Value"
      optional :master_lead_source_id, :message, 11, "google.protobuf.Int64Value"
      optional :is_converted_from_lead, :message, 12, "google.protobuf.BoolValue"
      optional :is_do_not_call, :message, 13, "google.protobuf.BoolValue"
      optional :birthday, :message, 14, "google.protobuf.StringValue"
      optional :master_country_id, :message, 15, "google.protobuf.Int64Value"
      optional :master_province_id, :message, 16, "google.protobuf.Int64Value"
      optional :master_district_id, :message, 17, "google.protobuf.Int64Value"
      optional :master_ward_id, :message, 18, "google.protobuf.Int64Value"
      optional :street, :message, 19, "google.protobuf.StringValue"
